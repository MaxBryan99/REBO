...
namespace SisBicimotoApp.Clases
{
    internal class ClsDetNotDeb
    {
        ...
        public ClsDetNotDeb(string IdNoDeb, string Codigo, string Marca, string Unidad, string Proced, double PVenta,
        ...
        {
            Boolean res = false;
            int resultado = csql.comando_cadena("Call SpDetNotDebCrear('" +
