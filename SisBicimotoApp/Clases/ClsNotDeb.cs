...
{
    internal class ClsNotDeb
    {
        public string IdNoDeb;
        public string Fecha;
        ...
        public ClsNotDeb(string IdNoDeb, string Fecha, string Cliente, string TipDocCli, string Doc,
                            ...
                            double Total, string Empresa, string Almacen, string ArchXml,
        ...
        {
            Boolean res = false;
            int resultado = csql.comando_cadena("Call SpNotaDebCrear('" +
                                                        this.IdNoDeb.ToString() + "','" +
                                                        this.Fecha.ToString() + "','" +
        ...
        public Boolean Modificar()
        {
            ...
            int resultado = csql.comando_cadena("Call SpNotaDebActualiza('" +
                                                this.IdNoDeb.ToString() + "','" +
                                                this.Fecha.ToString() + "','" +
                                                this.Cliente.ToString() + "','" +
                                                this.TipDocCli.ToString() + "','" +
        ...
        public Boolean BuscarND(string vIdND, string vRucEmpresa, string vAlmacen)
        {
            Boolean res = false;

            DataSet datos = csql.dataset_cadena("Call SpNotaDebBuscar('" + vIdND.ToString() + "','" + vRucEmpresa.ToString() + "','" + vAlmacen.ToString() + "')");
        ...
        public Boolean Eliminar(string vIdND, string vAlmacen, string vRucEmpresa, string vUsuario)
        {
            Boolean res = false;

            int resultado = csql.comando_cadena("Call SpNotaDebElimina('" + vIdND.ToString() + "','" + vRucEmpresa.ToString() + "','" + vAlmacen.ToString() + "','" + vUsuario.ToString() + "')");
        ...
        public Boolean Anular(string vIdND, string vAlmacen, string vRucEmpresa, string vUsuario)
        {
            Boolean res = false;

            int resultado = csql.comando_cadena("Call SpNotaDebAnula('" + vIdND.ToString() + "','" + vRucEmpresa.ToString() + "','" + vAlmacen.ToString() + "','" + vUsuario.ToString() + "')");
