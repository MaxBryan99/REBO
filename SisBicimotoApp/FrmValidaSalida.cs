...
{
    public partial class FrmValidaSalida : Form
    {
        ...
        private ClsSalida ObjSalida = new ClsSalida();

        public FrmValidaSalida()
        {
            InitializeComponent();
            valId = FrmSalidasAlm.nId.ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Está seguro de querer ELIMINAR el registro de salida?", "SISTEMA", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.No)
                {
                    return;
                }
                ...
                {*/
                if (ObjSalida.Eliminar(valId, codAlmacen, rucEmpresa, textBox1.Text.ToString().Trim()))
                {
